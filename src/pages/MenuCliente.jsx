    ...
    <div className="mcl-container">
      ...
      <div className="mcl-main">
        ...
        <div className="mcl-cards">
          ...
          <div className="mcl-card" onClick={() => navegarA('barberos')}>
            <div className="mcl-card-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg></div>
            <h3 className="mcl-card-title">Barberos</h3>
            <p className="mcl-card-desc">Elige tu barbero de confianza</p>
            <span className="mcl-card-arrow">→</span>
          </div>
